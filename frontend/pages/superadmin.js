...
const SuperAdminPage = () => {
  ...
  <h1 className="text-4xl text-center mt-11 font-bold mb-4">Super admin page</h1>
    ...
    <div key={category.id} className="border border-gray-300 rounded p-4 mb-4">
      {editingCategory === category ? (
        ...
        <div>
          ...
          <button onClick={() => handleDelete(category.id)} className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded mr-2">
            Delete
          </button>
          <button onClick={() => handleEdit(category)} className="bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-2 rounded">
            Edit
          </button>
        </div>
      )}
